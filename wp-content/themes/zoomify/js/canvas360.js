  ...
  startPreload = function() {
    ...
    imageLogo.onload = function() {
      ...
      for ( i = 0; i < params.framesCount; i++) {
		...
		if(i < 9){
			var repVal = ((i < 9) ? '00' : '') + (i + 1);
		}
		else if(i < 99){
			var repVal = ((i < 99) ? '0' : '') + (i + 1);
		}
		else{
			var repVal =  (i + 1);
		}
...
(jQuery)(document).ready(function(){
	if(jQuery('.pop360').length){
		(jQuery)(function (){
		  // Notice data attributes lose camelCase
			 canvas360({
				canvasId : '.pop360',
				canvasWidth : 1240,//parseInt((jQuery)(this).data('canvaswidth')),
				canvasHeight: 700,//parseInt((jQuery)(this).data('canvasheight')),
				framesPath : site_domine+'wp-content/themes/zoomify/img/animation/',//(jQuery)(this).data('framespath') || '',
				framesFile : 'Animacion0{col}?wid=750',//(jQuery)(this).data('framesfile'),
				framesReverse: true, // !!(jQuery)(this).data('framesreverse') || false
				framesCount : 120
			  });
		 })
	}
...
// Moviel
(jQuery)(document).ready(function(){
	if(jQuery('.pop360Moviel').length){
		(jQuery)(function (){
		  // Notice data attributes lose camelCase
			 canvas360({
				canvasId : '.pop360Moviel',
				canvasWidth : 600,//parseInt((jQuery)(this).data('canvaswidth')),
				canvasHeight: 339,//parseInt((jQuery)(this).data('canvasheight')),
				framesPath : site_domine+'wp-content/themes/zoomify/img/animation-moviel/',//(jQuery)(this).data('framespath') || '',
				framesFile : 'Animacion0{col}?wid=750',//(jQuery)(this).data('framesfile'),
				framesReverse: true, // !!(jQuery)(this).data('framesreverse') || false
				framesCount : 120
			  });
